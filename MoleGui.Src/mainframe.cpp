...
struct MyMainFrame: wxFrame
{
    ...
    wxPanel* CreateControls(wxWindow* parent)
    {
        ...
        wxTextCtrl* t0;
        h0->Add(new wxStaticText(pan,wxID_ANY,L"Exe-FILE",wxDefaultPosition,wxSize(50,-1),wxALIGN_RIGHT), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        h0->Add(t0 = new wxTextCtrl(pan,ctID_INPUTTEXT3,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                wxRIGHT|wxGROW|wxALIGN_CENTER_VERTICAL, 3);
        t0->Enable(false);
        v0->Add(h0, 1, wxALL|wxGROW|wxALIGN_LEFT, 1 );
        wxTextCtrl* t1;
        wxTextCtrl* t2;
        wxButton* b0;
        h1->Add(new wxStaticText(pan,wxID_ANY,L"Exe-CRC",wxDefaultPosition,wxSize(50,-1),wxALIGN_RIGHT), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        h1->Add(t1 = new wxTextCtrl(pan,ctID_INPUTTEXT3,wxEmptyString,wxDefaultPosition,wxSize(80,-1),wxTE_LEFT),0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL,0);
        h1->Add(new wxStaticText(pan,wxID_ANY,L"Packing Token",wxDefaultPosition,wxSize(90,-1),wxALIGN_RIGHT), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        h1->Add(t2 = new wxTextCtrl(pan,ctID_INPUTTEXT3,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT),1,
                wxRIGHT|wxGROW|wxALIGN_CENTER_VERTICAL,8);
        h1->Add(new wxButton(pan,ctID_BROWSE_SOURCE,L"What is it?",wxDefaultPosition,wxSize(60,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL,
                5);
        h1->Add(b0 = new wxButton(pan,ctID_BROWSE_SOURCE,L"Get One",wxDefaultPosition,wxSize(60,-1)), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
