...
struct QueryAddFilesDlg : wxDialog
{
    ...
    QueryAddFilesDlg(wxWindow* parent, ArrayT<StringW> const& names, StringW& ret)
        : wxDialog(parent,wxID_ANY,Tr(117,"Add Files"),wxDefaultPosition,wxDefaultSize,wxCAPTION),
          ret_(ret)
    {
    ...
    wxPanel* MakeSubControls(wxWindow* parent,ArrayT<StringW> const& names)
    {
        ...
        files->InsertColumn(0, Tr(118,"File name"), wxLIST_FORMAT_LEFT, 200);
        ...
        topszr->Add( new wxStaticText(pan,wxID_ANY,Tr(119,"The list of files")), 0, wxBOTTOM|wxTOP , 5 );
        topszr->Add( files, 1, wxGROW|wxBOTTOM , 5 );
        topszr->Add( new wxStaticText(pan,wxID_ANY,Tr(120,"The folder where files will be added")), 0, wxBOTTOM , 5 );
