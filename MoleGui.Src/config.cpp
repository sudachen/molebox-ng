    ...
    wxPanel *MakeTargetControls(wxWindow *parent)
      {
        ...
        if ( wxBoxSizer *rx = new wxBoxSizer(wxHORIZONTAL) )
          {
            ...
            rx->Add(new wxStaticText(pan,wxID_ANY,Tr(169,"If file named like embedded exists on disk: "),wxDefaultPosition,wxDefaultSize), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        ...
        r1->Add(build_vreg_ = new wxCheckBox(pan,ctID_CONTENT_BUILDREG,Tr(9,"Build virtual regestry")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
    ...
    wxPanel *MakeExecutableControls(wxWindow *parent)
      {
        ...
        wxSizer *r1 = new wxBoxSizer(wxHORIZONTAL);
        r1->Add(new wxStaticText(pan,wxID_ANY,Tr(13,"Mount external packages by mask"),wxDefaultPosition,wxSize(90,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        r1->Add(ext_mask_ = new MyTedit(pan,ctID_INPUTTEXT4,16), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 15);
        r1->Add(new wxStaticText(pan,wxID_ANY,Tr(14,"with password"),wxDefaultPosition,wxDefaultSize), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        ...
        r1->Add(anticrack_ = new wxCheckBox(pan,ctID_ANTICRACK,Tr(16,"Enable Anti-Crack features")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        ...
        if ( wxBoxSizer *rx = new wxBoxSizer(wxHORIZONTAL) )
          {
            rx->Add(cmdl_chk_ = new wxCheckBox(pan,ctID_CMDL,Tr(157,"Cmdline"),wxDefaultPosition,wxSize(90,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
        ...
        if ( wxBoxSizer *rx = new wxBoxSizer(wxHORIZONTAL) )
          {
            rx->Add(act_chk_ = new wxCheckBox(pan,ctID_ACT,Tr(166,"Activator"),wxDefaultPosition,wxSize(90,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
        ...
        if ( wxBoxSizer *rx = new wxBoxSizer(wxHORIZONTAL) )
          {
            rx->Add(regmask_chk_ = new wxCheckBox(pan,ctID_ACT,Tr(173,"Regmask"),wxDefaultPosition,wxSize(90,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
            ...
            //strings.Add(L"DELETE EXTERNAL");   
            rx->Add(new wxStaticText(pan,wxID_ANY,Tr(174,"Autoregister OCX/ActiveX: "),wxDefaultPosition,wxDefaultSize), 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
