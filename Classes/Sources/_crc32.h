...
namespace teggo
{
    ...
    _TEGGO_EXPORTABLE unsigned long  CXX_STDCALL Crc32(unsigned long crc, const unsigned char* buf, unsigned int len);
    _TEGGO_EXPORTABLE unsigned short CXX_STDCALL Crc16(unsigned short crc, unsigned char* pcBlock, unsigned short len);
    _TEGGO_EXPORTABLE unsigned char  CXX_STDCALL Crc8(unsigned char crc, unsigned char* pcBlock, unsigned char len);

    inline unsigned long  CXX_STDCALL Crc32(unsigned long crc, void const* buf, unsigned int len)
    { return Crc32(crc,(byte_t const*)buf,len); }
...
#define CRC32_MCRO_DO8(buf)  CRC32_MCRO_DO4(buf); CRC32_MCRO_DO4(buf);
    ...
    unsigned long CXX_STDCALL Crc32(unsigned long crc, const unsigned char* buf, unsigned int len)
    {
...
#undef CRC32_MCRO_DO8
    ...
    unsigned short CXX_STDCALL Crc16(unsigned short crc, unsigned char* pcBlock, unsigned short len)
    {
    ...
    unsigned char CXX_STDCALL Crc8(unsigned char crc, unsigned char* pcBlock, unsigned char len)
    {
