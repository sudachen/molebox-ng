...
struct ConfigDialog : wxDialog
{
    ...
    wxPanel* MakeTargetControls(wxWindow* parent)
    {
        ...
        r0->Add(target_ = new wxTextCtrl(pan,ctID_INPUTTEXT1,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                wxALIGN_CENTER_VERTICAL, 3 );
        ...
        r1->Add(new wxStaticText(pan,wxID_ANY,Tr(5,"Protect package with password"),wxDefaultPosition,/*wxSize(120,-1)*/wxDefaultSize),
        ...
        if ( wxBoxSizer* rx = new wxBoxSizer(wxHORIZONTAL) )
        {
            ...
            strings.Add(Tr(178,"USE EMBEDDED COPY"));
            strings.Add(Tr(179,"USE EXTERNAL COPY"));
            strings.Add(Tr(180,"ACCESS ERROR"));
            //strings.Add(L"DELETE EXTERNAL");
            rx->Add(new wxStaticText(pan,wxID_ANY,Tr(169,"If file named like embedded exists on disk: "),wxDefaultPosition,wxDefaultSize),
                    0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
            rx->Add(conflict_ = new wxChoice(pan,ctID_CONFLICT,wxDefaultPosition,/*wxSize(90,-1)*/wxDefaultSize,strings), 0,
        ...
        r1->Add(build_vreg_ = new wxCheckBox(pan,ctID_CONTENT_BUILDREG,Tr(9,"Build virtual regestry")), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        //r1->Add(encrypt_content_ = new wxCheckBox(pan,ctID_CONTENT_ENCRYPT,Tr(6,"Encrypt"));//, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        //r1->Add(compress_content_ = new wxCheckBox(pan,ctID_CONTENT_ZIP,Tr(7,"Compress"));//, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(hide_all_ = new wxCheckBox(pan,ctID_CONTENT_ZIP,Tr(165,"Hide all files")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
    ...
    {
        wxPanel* pan = new wxPanel(parent);
        wxBoxSizer* topszr = new wxStaticBoxSizer(new wxStaticBox(pan,wxID_ANY,Tr(10,"Executable processing parameters")),wxVERTICAL);
        //wxSizer *r00 = new wxGridSizer(1,3,0,0);
        topszr->Add(is_executable_ = new wxCheckBox(pan,ctID_HASCODE,Tr(8,"Merge source executable && package into one EXE file")),
                    0, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
        wxBoxSizer* r0 = new wxBoxSizer(wxHORIZONTAL);
        r0->Add(new wxStaticText(pan,wxID_ANY,Tr(11,"Source"),wxDefaultPosition,wxSize(90,-1)), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
        r0->Add(source_ = new wxTextCtrl(pan,ctID_INPUTTEXT3,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                wxALIGN_CENTER_VERTICAL, 0 );
        r0->Add(source_browse_ = new wxButton(pan,ctID_BROWSE_SOURCE,Tr(12,"BROWSE")), 0, wxLEFT|wxALIGN_CENTER_VERTICAL, 5 );
        topszr->Add(r0, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxGROW|wxALIGN_LEFT, 5 );

        wxSizer* r1 = new wxBoxSizer(wxHORIZONTAL);
        r1->Add(new wxStaticText(pan,wxID_ANY,Tr(13,"Mount external packages by mask"),wxDefaultPosition,wxSize(90,-1)), 0,
        ...
        r1->Add(new wxStaticText(pan,wxID_ANY,Tr(14,"with password"),wxDefaultPosition,wxDefaultSize), 0,
                wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
        ...
        r1->Add(relink_exec_ = new wxCheckBox(pan,ctID_RELINK,Tr(15,"Relink")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        //r1->Add(anticrack_ = new wxCheckBox(pan,ctID_ANTICRACK,Tr(0,"Strong Anti-Crack protection")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(do_logging_ = new wxCheckBox(pan,ctID_LOGGING,Tr(17,"Enable logging")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(use_vreg_ = new wxCheckBox(pan,ctID_EXE_USEREG,Tr(18,"Use virtual regestry")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(anticrack_ = new wxCheckBox(pan,ctID_ANTICRACK,Tr(16,"Enable Anti-Crack features")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL,
                10);
        r1->Add(do_saveiat_ = new wxCheckBox(pan,ctID_ANY,Tr(155,"Do not touch IAT")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(do_saversc_ = new wxCheckBox(pan,ctID_ANY,Tr(160,"Do not touch RSC")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(inject_ = new wxCheckBox(pan,ctID_ANY,Tr(170,"Inherit virtual environment")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(extradata_ = new wxCheckBox(pan,ctID_ANY,Tr(171,"Do not encrypt extra")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        r1->Add(fullreg_ = new wxCheckBox(pan,ctID_ANY,Tr(172,"Full registry virtualization")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        //r1->Add(autobundle_ = new wxCheckBox(pan,ctID_EXE_AUTOBUNDLE,Tr(19,"Auto bundle DLL dependies")), 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 10);
        ...
        if ( wxBoxSizer* rx = new wxBoxSizer(wxHORIZONTAL) )
        {
            rx->Add(cmdl_chk_ = new wxCheckBox(pan,ctID_CMDL,Tr(157,"Cmdline"),wxDefaultPosition,wxSize(90,-1)), 0,
                    wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
            rx->Add(cmdline_ = new wxTextCtrl(pan,ctID_COMMANDLINE,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                    wxALIGN_CENTER_VERTICAL, 0 );
        ...
        if ( wxBoxSizer* rx = new wxBoxSizer(wxHORIZONTAL) )
        {
            rx->Add(act_chk_ = new wxCheckBox(pan,ctID_ACT,Tr(166,"Activator"),wxDefaultPosition,wxSize(90,-1)), 0,
                    wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
            rx->Add(act_name_ = new wxTextCtrl(pan,ctID_ACTIVATOR,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                    wxALIGN_CENTER_VERTICAL, 0 );
            rx->Add(act_browse_ = new wxButton(pan,ctID_BROWSE_ACT,Tr(12,"BROWSE")), 0, wxLEFT|wxALIGN_CENTER_VERTICAL, 5 );
            topszr->Add(rx, 0, wxALL|wxGROW|wxALIGN_LEFT, 5 );
        }

        if ( wxBoxSizer* rx = new wxBoxSizer(wxHORIZONTAL) )
        {
            rx->Add(regmask_chk_ = new wxCheckBox(pan,ctID_ACT,Tr(173,"Regmask"),wxDefaultPosition,wxSize(90,-1)), 0,
                    wxRIGHT|wxALIGN_CENTER_VERTICAL, 3);
            rx->Add(regmask_ = new wxTextCtrl(pan,ctID_ACTIVATOR,wxEmptyString,wxDefaultPosition,wxDefaultSize,wxTE_LEFT), 1,
                    wxRIGHT|wxALIGN_CENTER_VERTICAL, 5 );
            wxArrayString strings;
            strings.Add(Tr(175,"DO NOT REGISTER"));
            strings.Add(Tr(176,"REGISTER ON START"));
            strings.Add(Tr(177,"REGISTER WHEN PACK"));
            //strings.Add(L"DELETE EXTERNAL");
            rx->Add(new wxStaticText(pan,wxID_ANY,Tr(174,"Autoregister OCX/ActiveX: "),wxDefaultPosition,wxDefaultSize), 0,
                    wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5);
            rx->Add(autoreg_ = new wxChoice(pan,ctID_CONFLICT,wxDefaultPosition,/*wxSize(90,-1)*/wxDefaultSize,strings), 0,
                    wxRIGHT|wxALIGN_CENTER_VERTICAL, 0);
    ...
    {
        wxString caption    = target?Tr(20,"Select Packing Target"):Tr(21,"Select Executable Source");
        wxString wildcard   = target?Tr(22,"Executable Target (*.exe)|*.exe|External Package (*.dat)|*.dat|Another File Name (*.*)|*.*")
                              :Tr(23,"Executable Source (*.exe)|*.exe");
        switch ( target )
        {
            case 0:
                caption    = Tr(21,"Select Executable Source");
                wildcard   = Tr(23,"Executable Source (*.exe)|*.exe");
                break;
            case 1:
                caption    = Tr(20,"Select Packing Target");
                wildcard   = Tr(22,"Executable Target (*.exe)|*.exe|External Package (*.dat)|*.dat|Another File Name (*.*)|*.*");
                break;
            case 2:
                caption    = Tr(167,"Select Activator");
                wildcard   = Tr(168,"Acivator DLL (*.dll)|*.dll|Another File Name (*.*)|*.*");
                break;
        }
