...
struct QueryNewSubfolderDlg : wxDialog
{
    ...
    QueryNewSubfolderDlg(wxWindow* parent,StringW& ret)
        : wxDialog(parent,wxID_ANY,Tr(131,"New Subfolder"),wxDefaultPosition,wxDefaultSize,wxCAPTION),
          ret_(ret)
    {
    ...
    wxPanel* MakeSubControls(wxWindow* parent)
    {
        ...
        topszr->Add( new wxStaticText(pan,wxID_ANY,Tr(132,"Enter name of new Subfolder here")), 0, wxBOTTOM|wxTOP , 5 );
        topszr->Add( subfold_, 1, wxGROW|wxBOTTOM , 5 );
        topszr->Add( new wxStaticText(pan,wxID_ANY,Tr(133,"Select the Parent folder")), 0, wxBOTTOM , 5 );
